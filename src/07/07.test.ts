  ...
  describe('calculations', () => {
    describe('calculateHandType', () => {
      const tests = [
        ...
        {
          Name: 'Example 1',
          Hand: { Cards: 'AAAAA', Bid: 0 },
          Want: HandType.FiveKind
        },
        {
          Name: 'Example 2',
          Hand: { Cards: 'AA8AA', Bid: 0 },
          Want: HandType.FourKind
        },
        {
          Name: 'Example 3',
          Hand: { Cards: '23332', Bid: 0 },
          Want: HandType.FullHouse
        },
        {
          Name: 'Example 4',
          Hand: { Cards: 'TTT98', Bid: 0 },
          Want: HandType.ThreeKind
        },
        {
          Name: 'Example 5',
          Hand: { Cards: '23432', Bid: 0 },
          Want: HandType.TwoPair
        },
        {
          Name: 'Example 6',
          Hand: { Cards: 'A23A4', Bid: 0 },
          Want: HandType.OnePair
        },
        {
          Name: 'Example 7',
          Hand: { Cards: '23456', Bid: 0 },
